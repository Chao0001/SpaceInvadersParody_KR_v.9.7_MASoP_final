//ѕароди€ Space Invaders на SFML на €зыке C++
//SFML 2.5.1 устанавливалс€ через диспетчер пакетов NuGet
//»спользовалс€ MS Visual Studio 2019, набор инструментов Visual Studio 2017 v.141, SDK 10.0.18362.0
